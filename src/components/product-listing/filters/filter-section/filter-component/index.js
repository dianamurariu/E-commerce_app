...
export default function FilterComponent({ title, opt1, opt2, opt3, opt4, opt5 }) {
  ...
  const imgsrc = expanded
    ? "/images/filter-arrow-up.svg"
    : "/images/filter-arrow-down.svg";
  ...
  return (
    <div className={styles.wrapper_component}>
      ...
      {expanded && (
        <ul>
          <li>
            <ButtonFilter option={opt1} />
          </li>
          <li>
            <ButtonFilter option={opt2} />
          </li>
          <li>
            <ButtonFilter option={opt3} />
          </li>
          <li>
            <ButtonFilter option={opt4} />
          </li>
          <li>
            <ButtonFilter option={opt5} />
          </li>
        </ul>
      )}
    </div>
