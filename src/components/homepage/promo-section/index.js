          ...
          <GridLayout>
            <div className={styles.leftSide}>
              <div className={styles.wrapper_title}>
                <Title level="h2" style="weight700">
                  YAAY! KING&apos;S DAY!
                </Title>
              </div>
              <Button
                style="btnPromo text-promo"
                text="⏰  This offer valid only untill 1st of May"
              />
              <div className={styles.wrapper_subtitle}>
                <Title level="h3" style="weight400">
                  Grab a{" "}
                  <strong className={styles.strongText}>treat basket</strong>{" "}
            ...
            <div className={styles.rightSide}>
              <div className={styles.wrapper_basket}>
                <Basket
                  imgstyle="dark"
                  text="Party Must-Haves"
                  price="$8."
                  price_decimal="90"
                />
                <Basket
                  imgstyle="light"
                  text="For king and his queen"
                  price="$8."
                  price_decimal="90"
                />
                <Basket
                  imgstyle="light"
                  text="King's decorations"
                  price="$8."
                  price_decimal="90"
                />
                <Basket
                  imgstyle="dark"
                  text="King's day with Family"
                  price="$8."
                  price_decimal="90"
                />
              </div>
