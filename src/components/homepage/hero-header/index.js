        ...
        <div className={styles.wrapper__hero}>
            <div className="container">
                ...
                <div className={styles.wrapper_title}>
                    <Title level="h1" style="weight700">Your <strong className={styles.strongText}>dutch store, </strong>always closed.</Title>
                </div>
                    ...
                    <a className={styles.link} href="#promoSection">
                        <Button style="btnDark btnLarge text-white btnHover" text="Check out the deals" 
                        imgposition="left" imgsrc="images/percent.svg" imgwidth={16} imgheight={16}  />
                    </a> 
                </div>
                <div className={styles.rightSide}>
                    <Image src="images/Products.svg" alt="image" width={532} height={286} />
                </div>
                </GridLayout>
            </div>
        </div>
