  ...
  return (
    <div className={styles.wrapper_purchase_info}>
      <div className={styles.wrapper_meta_deta}>
        <ButtonDetails className={styles.btnNew}>
          <strong className={styles.strongText1}>NEW</strong>
        </ButtonDetails>
        <TitleDetails level="h1">{title}</TitleDetails>
        <p className={styles.text}>{description}</p>
        <ButtonDetails>
          Free delivery on orders more than{" "}
          <strong className={styles.strongText2}> $39.90</strong>
        </ButtonDetails>
        <ButtonDetails>Arrives Wednesday, 1st of July</ButtonDetails>
      </div>
      <div className={styles.price_tag}>
        <span className={styles.priceInteger}>${price_integer}</span>
        <sup className={`${styles.priceDecimal} ${styles.superscript}`}>
          {price_decimal}
        </sup>
      </div>
